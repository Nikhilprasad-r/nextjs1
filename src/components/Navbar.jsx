    ...
    <nav className="bg-white w-full z-20 text-base top-0 start-0 border-b border-gray-200 fixed font-[basiersquare]">
      <div className="max-w-screen-xl flex flex-nowrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2  items-center space-x-6 md:space-x-0 rtl:space-x-reverse">
          <div className="text-base hidden md:block text-neutral-400 hover:text-blue-600 mr-6">
            Log in
          </div>
          <button
            type="button"
        ...
        <div
          className={clsx(
            "fixed h-full w-screen md:hidden bg-white top-0 left-0  transition-all delay-75",
        ...
        >
          ...
          <div className="flex flex-col justify-between">
            <div className="w-full relative overflow-y px-5 gap-x-0 border-b border-[#e4e4e4] border-solid flex flex-col mx-0 my-auto flex-shrink flex-grow basis-0">
              ...
              <div className="flex group pt-6 pb-3 px-3 text-neutral-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 border-b-[1px] border-[#cfd4e4]">
                Pricing
              </div>
